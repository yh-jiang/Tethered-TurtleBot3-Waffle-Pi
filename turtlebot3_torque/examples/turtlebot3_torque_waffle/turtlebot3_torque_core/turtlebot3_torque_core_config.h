...
#include <TurtleBot3_torque.h>
#include "turtlebot3_torque_waffle.h"
...
#define CONTROL_MOTOR_TORQUE_FREQUENCY         50   //hz, modifiable, should be higher than publish rate?
#define CONTROL_MOTOR_TIMEOUT                  500  //ms, modifiable
#define IMU_PUBLISH_FREQUENCY                  200  //hz
#define CMD_PUBLISH_FREQUENCY                  50   //hz
...
ros::Subscriber<std_msgs::Float64> cmd_torque_left_sub("cmd_torque_left", commandTorqueCallbackLeft);

ros::Subscriber<std_msgs::Float64> cmd_torque_right_sub("cmd_torque_right", commandTorqueCallbackRight);
...
std_msgs::Float64 cmd_torque_left_msg;
std_msgs::Float64 cmd_torque_right_msg;
std_msgs::UInt32 return_left_value_msg;
ros::Publisher cmd_torque_left_pub("cmd_torque_left_pub", &cmd_torque_left_msg);
ros::Publisher cmd_torque_right_pub("cmd_torque_right_pub", &cmd_torque_right_msg);
ros::Publisher return_left_value_pub("return_left_value_pub", &return_left_value_msg);
...
float goal_torque[WHEEL_NUM] = {0.0, 0.0};
float return_left_value = 0.0;
